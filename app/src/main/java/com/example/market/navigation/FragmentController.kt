...
//        fragmentManager.fragments.apply {
//            return if (graphIds.size>0) findFrgamentByTag(graphIds[graphIds.size-1]) else null
//        }
//    }
//
...
//                                        onViewAttachedToParent()
//
//                                        if (view.background == null) { view.setBackgroundColor(Theme.getColor(Theme.key_windowBackground)) }
