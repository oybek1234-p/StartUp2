...
public class DataBoundViewHolder<T extends ViewDataBinding> extends RecyclerView.ViewHolder {
    ...
    public DataBoundViewHolder(T binding,RecyclerItemClickListener clickListener) {
        ...
        if (clickListener!=null){
            binding.getRoot().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    clickListener.onClick(getAdapterPosition(),getItemViewType());
                }
            });
        }
    }
    ...
    public static <T extends ViewDataBinding> DataBoundViewHolder<T> create(ViewGroup parent,
                                                                            @LayoutRes int layoutId, RecyclerItemClickListener clickListener) {
        T binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
                layoutId, parent, false);

        return new DataBoundViewHolder<>(binding,clickListener);
    }
}
